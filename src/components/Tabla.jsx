...
const rows = [
  createData('CABA', '', '', 168, 3, 25),
  createData('Buenos Aires', '', '', 132, 2, 1),
  createData('Chaco', '', '', 53, 3, 0),
  createData('Córdoba', '', '', 49, 0, 0),
  createData('Tierra del Fuego', '', '', 11, 0, 0),
  createData('Entre Ríos', '', '', 6, 0, 0),
  createData('Río Negro', '', '', 4, 0, 1),
  createData('Neuquén', '', '', 2, 0, 0),
  createData('Santa Fe', '', '', 42, 0, 0),
  createData('Mendoza', '', '', 6, 0, 0),
  createData('San Luis', '', '', 1, 0, 0),
  createData('Santiago del Estero', '', '', 1, 0, 0),
  createData('Corrientes', '', '', 1, 0, 0),
  createData('Tucumán', '', '', 9, 0, 0),
  createData('Santa Cruz', '', '', 7, 0, 0),
